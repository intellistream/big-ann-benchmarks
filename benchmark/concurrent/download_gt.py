...
from benchmark.concurrent.load_runbook import load_runbook, get_gt_url
from benchmark.concurrent.compute_gt import gt_dir
...
def main():
    ...
    _, batch_size, gt_url, runbook = load_runbook(args.dataset, ds.nb, args.runbook_file)
