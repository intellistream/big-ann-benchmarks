...
from neurips23.streaming.spfresh.spfresh import SPFresh as SPFresh_streaming
import torch

class SPFresh(BaseCongestionDropANN):
    def __init__(self, metric, index_params):
        super().__init__([SPFresh_streaming(metric, index_params)], metric, index_params)
        self.metric = metric
