...
from neurips23.streaming.plsh.plsh import PLSH as plsh_streaming
import torch

class PLSH(BaseCongestionDropANN):
    def __init__(self, metric, index_params):
        super().__init__([plsh_streaming(metric, index_params)], metric, index_params)
        self.metric = metric
