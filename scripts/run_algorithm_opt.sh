...
DATASETS=("glove" "msong" "sun" "trevi" "dpr" "reddit" "random-experiment" "random-plus-experiment" "sift" "msturing-30M-clustered" "wte-0.05" "wte-0.2" "wte-0.4" "wte-0.6" "wte-0.8" "cirr" "coco")
